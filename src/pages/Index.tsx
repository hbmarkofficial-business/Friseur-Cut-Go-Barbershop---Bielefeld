  ...
  return (
    <>
      <Helmet>
        ...
        <title>Barbershop Bielefeld | Friseur Cut & Go</title>
        <meta
          name="description"
          content="Besuche unseren Premium Barbershop Friseur Cut & Go in Bielefeld für erstklassige Haarschnitte, Bartpflege und individuelle Styles. Jetzt Termin buchen!"
        />
        <meta
          name="keywords"
        ...
        {/* Open Graph */}
        <meta property="og:title" content="Friseur Cut & Go | Premium Barbershop Bielefeld" />
        <meta
        ...
        <meta name="twitter:title" content="Friseur Cut & Go | Premium Barbershop Bielefeld" />
        <meta
